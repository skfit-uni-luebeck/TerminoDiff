...
class PagerState(
    ...
    /**
     * The target page for any ongoing animations.
     */
    ...
    /**
     * The target page for any ongoing animations or scrolls by the user.
    ...
    override fun toString(): String = "libraries.accompanist.pager.PagerState(" +
            "pageCount=$pageCount, " +
