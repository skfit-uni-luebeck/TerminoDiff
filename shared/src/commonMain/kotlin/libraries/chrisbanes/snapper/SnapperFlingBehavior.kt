package libraries.chrisbanes.snapper
...
class SnapperFlingBehavior(
    ...
    /**
     * The target item index for any ongoing animations.
     */
        ...
        try {
            ...
            AnimationState(
                ...
                if (abs(delta - consumed) > 0.5f) {
                    // If some scroll was not consumed, cancel the animation now as we're
        ...
        try {
            ...
            AnimationState(
                ...
                if (performSnapBackIfNeeded(currentItem, targetIndex, ::scrollBy)) {
                    ...
                    // If we're still running but some scroll was not consumed,
