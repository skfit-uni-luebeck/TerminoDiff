package terminodiff.shared.ui.panes.conceptdiff
...
import terminodiff.shared.engine.graph.FhirConceptDetails
...
import terminodiff.shared.ui.util.NullableText
...
private fun propertyDesignationColumnSpec(
    ...
    title = localizedStrings.propertiesDesignations,
    weight = 0.25f,
            ...
            data.isInBoth() -> {
                ...
                when {
                    propertyDifferenceCount == 0 && designationDifferenceCount == 0 -> Button(onClick = {
                        ...
                        Text(
                            text = localizedStrings.propertiesDesignationsCount(
                                data.diff.propertyComparison.count(),
                                data.diff.designationComparison.count()
                        ...
                        Row {
                            Button(
                                ...
                                colors = ButtonDefaults.buttonColors(
                                    diffColors.yellowPair.first,
                                    diffColors.yellowPair.second
                                )
                            ) {
                                Text(
                                    text = localizedStrings.propertiesDesignationsCountDelta.invoke(
                                        data.diff.propertyComparison.count() to propertyDifferenceCount,
...
//                        contentColor = colorScheme.onTertiaryContainer),
                    ...
                    val text = when (data.isOnlyInLeft()) {
                        ...
                        localizedStrings.propertiesDesignationsCount.invoke(
                            details.property.count(),
