package terminodiff.shared.engine.resources
...
import terminodiff.shared.ui.panes.loaddata.panes.fromserver.DownloadableCodeSystem
import java.io.File
...
data class InputResource(
    ...
    suspend fun downloadRemoteFile(ktorClient: HttpClient): InputResource = when {
        ...
        (kind == Kind.FHIR_SERVER || kind == Kind.VREAD) && resourceUrl != null -> {
            val tempFilePath = createTempFile(prefix = "terminodiff", suffix = ".json")
